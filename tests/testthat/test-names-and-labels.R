...
test_that("inquiry labels work", {
  ...
  mator_2 <- declare_estimator(inquiry = mand_2, handler = label_estimator(my_private_estimator))
  ...
  mator_3 <- declare_estimator(inquiry = mand_3, handler = label_estimator(my_private_estimator))
  ...
  mator_4 <- declare_estimator(inquiry = mand_4, handler = label_estimator(my_private_estimator))
