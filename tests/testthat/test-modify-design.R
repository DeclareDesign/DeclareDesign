...
test_that("test modify declare design ", {
  ...
  my_assignment <- declare_assignment(handler = assignment_handler, Z = complete_ra(N, m = 25), label = "a_label")
  ...
  my_assignment_2 <- declare_assignment(handler = assignment_handler, Z2 = complete_ra(N, m = 25))
...
test_that("placement doesn't matter", {
  ...
  my_assignment_2 <- declare_assignment(handler = assignment_handler, Z = complete_ra(N, m = 25))
