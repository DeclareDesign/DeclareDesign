...
test_that("compare_designs works", {
  ...
  expect_equal(comparison$diagnosands$design_label, c("my_design_1","my_design_2"))
  ...
  expect_equal(comparison$diagnosands$design_label, c("design_1","design_2"))
  ...
  expect_equal(comparison$diagnosands$design_label, c("d1", "d2"))
  ...
  expect_true(all(comparison$diagnosands$design_label %in% c("my_design_1", "a_design_2")))
