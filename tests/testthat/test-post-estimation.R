...
test_that("tidy works", {
  ...
  des <-
    ...
    declare_estimator(
      extra ~ group,
      model = lm_robust,
      post_estimation = ~ tidy_filter(., term = FALSE),
      label = "formula2"
    ) +
    declare_estimator(
      extra ~ group,
  ...
  expect_equal(est, structure(
    list(
      estimator_label = c("formula1", "formula2", "bare",
                          "string"),
      term = c("group2", "group2", "group2", "group2"),
      estimate = c(1.58, 1.58, 1.58, 1.58),
      std.error = c(
        0.849091017238762,
        0.849091017238762,
        0.849091017238762,
      ...
      conf.low = c(
        -0.203874032287598,-0.203874032287598,
        -0.203874032287598,
        -0.203874032287598
      ),
      conf.high = c(
  ...
  des <-
    ...
    declare_estimator(
      extra ~ group,
      model = lm_robust,
      post_estimation = ~ tidy_filter(., term = TRUE),
      label = "formula1"
    ) +
    declare_estimator(
      extra ~ group,
  ...
  expect_equal(est, structure(
    list(
      ...
      estimate = c(0.75, 1.58, 0.75, 1.58, 0.75, 1.58, 0.75,
                   1.58),
      std.error = c(
        0.565734527455728,
        0.849091017238762,
  ...
  des <-
    ...
    declare_estimator(
      extra ~ group,
      model = lm_robust,
      post_estimation = ~ tidy_filter(., term = "group2"),
      label = "formula1"
    ) +
    declare_estimator(
      extra ~ group,
  ...
  est <- draw_estimates(des)
  expect_equal(est, structure(list(estimator_label = c("formula1", "formula2", "bare", 
                                                       "string"), term = c("group2", "group2", "group2", "group2"), 
                                   estimate = c(1.58, 1.58, 1.58, 1.58), std.error = c(0.849091017238762, 
                                                                                       0.849091017238762, 0.849091017238762, 0.849091017238762), 
                                   statistic = c(1.86081346748685, 1.86081346748685, 1.86081346748685, 
                                                 1.86081346748685), p.value = c(0.0791867142159381, 0.0791867142159381, 
                                                                                0.0791867142159381, 0.0791867142159381), conf.low = c(-0.203874032287598, 
                                                                                                                                      -0.203874032287598, -0.203874032287598, -0.203874032287598
                                                                                ), conf.high = c(3.3638740322876, 3.3638740322876, 3.3638740322876, 
                                                                                                 3.3638740322876), df = c(18, 18, 18, 18), outcome = c("extra", 
                                                                                                                                                       "extra", "extra", "extra")), row.names = c(NA, -4L), class = "data.frame"))
  ...
  expect_equal(est, structure(list(estimator_label = c("formula2", "bare", "string"
  ), term = c("group2", "group2", "group2"), estimate = c(1.58, 
                                                          1.58, 1.58), std.error = c(0.849091017238762, 0.849091017238762, 
                                                                                     0.849091017238762), statistic = c(1.86081346748685, 1.86081346748685, 
                                                                                                                       1.86081346748685), p.value = c(0.0791867142159381, 0.0791867142159381, 
                                                                                                                                                      0.0791867142159381), conf.low = c(-0.203874032287598, -0.203874032287598, 
                                                                                                                                                                                        -0.203874032287598), conf.high = c(3.3638740322876, 3.3638740322876, 
                                                                                                                                                                                                                           3.3638740322876), df = c(18, 18, 18), outcome = c("extra", "extra", 
                                                                                                                                                                                                                                                                             "extra")), row.names = c(NA, -3L), class = "data.frame"))
