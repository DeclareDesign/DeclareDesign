...
diagnosand_handler <- function(data, ..., 
  ...
  defaults_quos <- 
    quos(
      ...
      type_s_rate = mean((sign(estimate) != sign(estimand))[ p < alpha ] ),
...
#' type_s_rate = mean((sign(estimate) != sign(estimand))[p < alpha])\cr
