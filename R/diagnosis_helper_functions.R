...
#'
#' @param diagnosis A diagnosis object (list) generated by \code{diagnose_design}. 
#' @param digits Number of digits.
#' @param select Set of columns to include in output. Defaults to all.
...
#' # reshape_diagnosis(diagnosis, exclude = c("Design Label", "Term"))
