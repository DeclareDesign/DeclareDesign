...
#'   )
#'
#' my_sampling <- declare_sampling(S = complete_rs(N, n = 250), handler = sampling_handler)
#'
#' my_assignment <- declare_assignment(Z = complete_ra(N, m = 25), handler = assignment_handler)
#'
