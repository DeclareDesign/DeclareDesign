...
declare_assignment <- function(assignment_function = conduct_ra,
  ...
  assignment_function_internal <- function(data){
    ...
    data[, assignment_variable_name] <- do.call(assignment_function, args = assignment_function_options, envir = data_environment)
  ...
  attributes(assignment_function_return_internal) <- list(call = match.call(),
                                                          type = "assignment",
