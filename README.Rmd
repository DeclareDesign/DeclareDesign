...
2. `declare_inquiry()` (takes data and returns an estimand, the answer to an inquiry)
...
4. `draw_inquiries()` (takes a design and returns a single simulation of estimands)
