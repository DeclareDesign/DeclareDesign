...
<div class="btn-group">
  <a class="btn btn-lg btn-primary" href="http://declaredesign.org/articles/two_arm.R">
    <i class="fa fa-code" title = "Download code for design" fa-2x></i> Download code
  </a>
  <a class="btn btn-lg btn-primary" href="http://declaredesign.org/articles/two_arm_template.RDS">
