...
Delegates can also make use of labels, if it's declared as an argument to the custom delegate function.
...
Custom estimators are slightly different - the default delegate itself calls another function, either a model or estimator function, and handles the necessary book keeping to align estimators and estimands to later calculate diagnostics.
