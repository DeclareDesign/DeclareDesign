...
Custom estimators are slightly different - the default handler itself calls a model function. To implement a new handler, you can use the custom_estimator
