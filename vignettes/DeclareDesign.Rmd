...
To declare an estimator, you declare an estimator function, a [`difference_in_means()`](http://declaredesign.org/R/estimatr/reference/difference_in_means.html) by default. Optionally you also declare an estimand that is attached to the estimator.
...
Next, we recommend you read the [Custom functions](http://declaredesign.org/R/DeclareDesign/articles/custom_functions.html) tutorial to learn how to provide custom functions to replace any step of `declare_design()`. You can also read about [`fill_out()` and other advanced features](http://declaredesign.org/R/DeclareDesign/articles/advanced_features.html) in our Advanced features tutorial.

Finally, you can [learn about DeclareDesign’s companion packages](http://declaredesign.org/R/DeclareDesign/articles/companion_packages.html).
