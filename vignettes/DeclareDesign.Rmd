...
The `DeclareDesign` package has a small set of core functions.  

Six core functions are used to describe key steps in a research design:
...
There are also six core post-design-declaration commands:
