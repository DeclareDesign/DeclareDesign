...
Next, we recommend you read the [Custom functions](/R/DeclareDesign/articles/custom_functions.html) tutorial to learn how to provide custom functions to replace any step of `declare_design()`. You can also read about [`fill_out()` and other advanced features](/R/DeclareDesign/articles/advanced_features.html) in our Advanced features tutorial.
